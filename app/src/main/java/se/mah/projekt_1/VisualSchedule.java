...
public class VisualSchedule extends View {
    ...
    public VisualSchedule(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mHourHeight = array.getFloat(R.styleable.VisualSchedule_hourHeightz, mHourHeight);
            mTextSize = array.getFloat(R.styleable.VisualSchedule_textSizez, mTextSize);
    ...
    private void drawEvents(Canvas canvas) {
        ...
        for (GraphEvent event : dailyEvents) {
            ...
            Log.v(TAG, "is stamp: " + event.isStamp());
            if (event.isStamp()) {
