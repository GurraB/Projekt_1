...
public class LoginServiceTest extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        //AndroidStamp[] stamps = new ServerCommunicationService().getStampsForUser(url1, "user", "pass", acc.getRfidKey().getId(), String.valueOf(from.getTimeInMillis()), String.valueOf(to.getTimeInMillis()));
