 ...
 */
public class FixedCalendarView extends View {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            switch (mCurrentScrollDirection) {
                ...
                case RIGHT:
                    ...
                    ViewCompat.postInvalidateOnAnimation(FixedCalendarView.this);
                    break;
                case VERTICAL:
    ...
    public FixedCalendarView(Context context) {
        this(context, null);
    }

    public FixedCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixedCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
